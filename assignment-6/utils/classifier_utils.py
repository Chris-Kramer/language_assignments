...
def plot_cm(y_test, y_pred, normalized:bool, output = "confusion_matrix.png"):
    """
    ...
    if normalized == False:
        ...
        p.figure.savefig(output)

        return None
    
# Plot learning-validation curve
def plot_learning_curve(estimator, title, X, y, axes=None, ylim=None, cv=None,
                        n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5), output = "cross_validation_logistic_regression.png"):
    """
